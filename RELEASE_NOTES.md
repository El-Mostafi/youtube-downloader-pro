# Release v1.0.0 - YouTube Downloader Pro

## 🎉 First Official Release!

A modern, professional desktop application for downloading YouTube videos and audio.
...
- 📁 **Custom Location** - Choose download folder
...
2. Extract and run `QUICK_START.bat`
...
2. Extract and run `YouTubeDownloaderPro.exe`
3. Start downloading!

**Note:** ~80MB file size (includes Python runtime)
...
- First executable launch may be slow (10-15 seconds)
- Some antivirus may flag false positive on .exe
- FFmpeg required for best quality (optional)

### 📖 Documentation

- [Installation Guide](https://github.com/El-Mostafi/youtube-downloader-pro#-installation-options)
- [Audio Feature Guide](AUDIO_FEATURE.md)
- [Playlist Guide](PLAYLIST_FEATURE.md)
...
- yt-dlp team for the excellent downloader
